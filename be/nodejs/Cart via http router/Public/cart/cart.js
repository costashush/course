...
$.fn.shop = function(cartselector) {
    ...
    function insertHtml(products, selector, start) {
        ...
        for (var i = 0; i < products.length; i++) {
            ...
            var newName = $('<h3>', { "text": products[i].product, });
    ...
    function checkOut() {
        ...
        var i = 1;
        for (items in basket) {
            var prodname = $('<input>', { "type": "hidden", "name": "item_name_" + i, "value": basket[items].product });
    ...
    function loadAj() {
        ...
        socket = io.connect();
        socket.emit('needProducts');
        ////////////////////////////////////////////
        socket.on('productsLoad', function(data) {
            // display(data)
